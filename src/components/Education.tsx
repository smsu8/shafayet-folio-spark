...
const Education: React.FC = () => {
  ...
  return <section id="education" className="py-20 bg-muted">
      <div className="section-container">
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {educationItems.map((item, index) => <div key={item.institution} className="relative animate-slide-up" style={{
            animationDelay: `${index * 0.2}s`
                ...
                <div className="absolute left-4 md:left-1/2 transform -translate-x-4 md:-translate-x-4 flex items-center justify-center">
                  <div className="bg-primary h-8 w-8 rounded-full flex items-center justify-center">
                    {item.icon === "school" ? <School className="h-4 w-4 text-primary-foreground" /> : <GraduationCap className="h-4 w-4 text-primary-foreground" />}
                  </div>
                </div>
